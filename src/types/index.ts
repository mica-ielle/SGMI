...
export interface DashboardStats {
  ...
  alertesStock: number;
  equipementsParType: EquipementTypeStats[];
  maintenancesParMois: MaintenanceStats[];
  stocksCritiques: StockCritique[];
  prochainesmaintenances: ProchaineMaintenanceInfo[];
}

export interface EquipementTypeStats {
  type: TypeEquipement;
  count: number;
  pourcentage: number;
}
...
export interface StockCritique {
  id_stock: number;
  piece: Piece;
  quantite: number;
...
export interface ProchaineMaintenanceInfo {
