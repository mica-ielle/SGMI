...
import type { FicheIntervention, Resultat, Equipement, Piece, PieceRemplacee, Site, EquipementInstalle, RequetCreateFiche } from '../../types';
...
export const DefaillanceForm = ({ 
  ...
  const handleSubmit = async () => {
    try {
      ...
      await planningService.createFicheIntervention(finalData);
      console.log('Submitting defaillance:', finalData);
      
      toast.success('Fiche de défaillance créée avec succès');
      onSuccess();
      onOpenChange(false);
    } catch (error) {
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] p-0">
        <DialogHeader className="p-6 pb-0">
          <DialogTitle className="flex items-center gap-2">
            ...
            {initialData ? 'Modifier la fiche de défaillance' : 'Nouvelle fiche de défaillance'}
          </DialogTitle>
          {selectedEquipementInstalle && (
        ...
        <div className="flex-1 overflow-auto p-6" style={{ maxHeight: 'calc(90vh - 200px)' }}>
          <div className="space-y-6">
            ...
            <FormSection 
              ...
              description="Informations sur l'équipement en défaillance"
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <Label>Équipement en défaillance *</Label>
                  <Select
            ...
            <FormSection 
              title="Informations de la défaillance" 
              description="Détails sur la panne et l'intervention"
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Obligatoire - Décrivez les symptômes observés
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Obligatoire - Analyse de la cause du dysfonctionnement
                  </p>
                </div>

                <div>
                  <Label>Description détaillée de l'intervention *</Label>
                  <Textarea
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Détaillez les réparations, remplacements, ajustements effectués..."
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Recommandations, mesures préventives, observations particulières..."
            ...
            <FormSection 
              title="Intervenants" 
              description="Personnes ayant participé à la résolution de la défaillance"
            ...
            <FormSection 
              ...
              description="Pièces défaillantes remplacées lors de l'intervention"
              icon={<Package className="w-4 h-4" />}
            >
              <div className="space-y-4">
            ...
            <FormSection 
              ...
              description="Répartition des coûts de réparation (main-d'œuvre, pièces, autres frais)"
            ...
            <FormSection 
              ...
              description="Photos de la panne, rapports techniques, documents de réparation"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <Button 
                ...
                disabled={loading || !formData.descriptionIntervention.trim() || !formData.problemeRencontre?.trim() || !formData.cause?.trim() || !selectedSiteId || !selectedEquipementInstalle}
